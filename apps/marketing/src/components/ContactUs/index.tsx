      ...
      <Box borderRadius="lg" m={{ base: 5, md: 16, lg: 10 }} p={{ base: 5, lg: 16 }}>
        <Box>
          <VStack spacing={{ lg: 5 }}>
            ...
            <Stack spacing={{ lg: 5 }} direction={{ base: 'column', md: 'row' }}>
              <Stack
                align="center"
              ...
              <Box bg="brand.300" borderRadius="lg" p={8} color="black" shadow="base" w={400}>
                <VStack spacing={2}>
                  <FormProvider {...methods}>
                    ...
                    <Spacer />
                    <Spacer />
                    <Button bgColor="gray.800" width="full">
                      Send Message
                    </Button>
                  </FormProvider>
                </VStack>
